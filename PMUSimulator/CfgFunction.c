...
* It generates the Header Frame from user given information about PMU and store in a PMU Setup File                                            
 ***********************************************/
...
{ 
    ...
    while (field) 
    {
        ...
        else if((field_count>=19)&&(field_count<=19+dgnmr*16-1))/*Digital values*/
        {
            a=strtod(field , NULL);
    ...
    for(int local_count_1=0;local_count_1<dgnmr;local_count_1++)
    {
        ...
        {
            b=b+dig[local_count_1*16+local_count]*(1<<local_count);
        }
